...
<article id="ijikanri" class="clearfix anchor">
<h2 class="title ">維持管理
</h2>

<p class="txt-ll">定期的な維持メンテナンスで建物を守ります</p>
<p>
  配管設備などをメンテナンスしやすい様に点検口を適切に設置し、定期点検によって建物を維持します。点検内容や補修内容は住宅履歴管理に保管しますので、建物の状況がし
</p>


<p class="w100 w890">
<img src="<?php bloginfo('stylesheet_directory'); ?>/images/builder/ijikanri001.jpg" alt="建物の維持管理">
</p>
</article><!--ijikanri-->
...
<div class="r-box w33">
  ...
  <p class="w100">
  <img src="<?php bloginfo('stylesheet_directory'); ?>/images/builder/tenkenkou003.jpg" alt="天井点検口">
</p>
</div><!--R-->
</div>
