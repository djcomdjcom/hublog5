...
<div class="r-box w50">
  <p class="w100">
  <img src="<?php bloginfo('stylesheet_directory'); ?>/images/builder/financialplan000.jpg" alt="住宅資金計画のイメージ">
  </p>
...
<p class="w100 w890">
<img src="<?php bloginfo('stylesheet_directory'); ?>/images/builder/financialplan002.jpg" alt="住宅資金計画のイメージ">
</p>
...
<p>
  間違った資金計画とは、建築費用に対する支払能力だけしか計算しない資金計画です。<br>
...
<p>
  お見積り価格には、建物本体価格だけでなく、地盤改良費、屋外給排水ガス工事費、申請費用、照明器具、エアコン、照明器具、カーテン、外構工事など、すべて含まれます。<br>
    後から追加で費用請求するような資金計画の仕方はいたしません。
</p>
<p>※住宅ローンの手数料、税金関連、火災保険など、建物とは関係無いものをお見積書に含むことはできませんので、その分は別途資金計画書で明記します。</p>

  <p class="w100 w890">
  <img src="<?php bloginfo('stylesheet_directory'); ?>/images/builder/financialplan004.jpg" alt="住宅の見積りのイメージ">
  </p>
...
<p>
  当社の家づくりへの思いや、建物基準についてのご説明と、間取りプランのご提案と資金計画に則った概算お見積りをご説明するマイホーム計画書をご提示します。<br>
...
<p class="w100">
<img src="<?php bloginfo('stylesheet_directory'); ?>/images/builder/financialplan006.jpg" alt="住宅ローンのイメージ">
</p>
...
<p class="w100 w890">
<img src="<?php bloginfo('stylesheet_directory'); ?>/images/builder/financialplan007.jpg" alt="住宅災害保険のイメージ">
</p>
...
<p class="w100">
<img src="<?php bloginfo('stylesheet_directory'); ?>/images/sample-image.png" alt="住宅瑕疵保険のイメージ">
</p>
