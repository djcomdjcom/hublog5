...
<?php query_posts('pagename=staff'); ?>
<?php if (have_posts()) : ?>
<div class="inbox" id="side-staff_link">

	<span class="to_staff"><a href="/staff">スタッフ紹介</a></span>

	<?php query_posts('category_name=shokunin'); ?>
	<?php if (have_posts()) : ?>
	<span class="to_shokunin"><a href="/staff#shokunin">職人・協力会社紹介</a></span>
	<?php endif; ?>
</div><!--inbox-->		
<?php endif; ?>
